...
export default function ChatInvite() {
  return (
    <div className="absolute top-50 right-0 bg-[#111827] text-gray-200 border border-blue-500/50 rounded-2xl p-5 w-[280px] md:w-[320px] shadow-lg">
      ...
      <button className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-xl transition-all hover:scale-110 transition-transform duration-300">
